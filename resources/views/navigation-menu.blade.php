<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="60">
                        ...
                        <x-slot name="content">
                            <div class="w-60">
                                @can('viewTelescope')
                                    <x-dropdown-link href="{{ route('telescope') }}" target="_blank">
                                        {{ __('Telescope') }}
                                    </x-dropdown-link>
                                @endcan
                                ...
                                @can('viewPulse')
                                    <x-dropdown-link href="/pulse" target="_blank">
                                        {{ __('Pulse') }}
                                    </x-dropdown-link>
                                @endcan
                            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('viewHorizon')
                <x-responsive-nav-link href="{{ route('horizon.index') }}" target="_blank">
                    {{ __('Horizon') }}
                </x-responsive-nav-link>
            @endcan
